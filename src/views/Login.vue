...
<section id="homeSection" style="min-height: 85vh;">
  <b-container class="my-5 container text-black" v-if="!content">
    <div class="row">
      <div class="col-12">
  ...
  <b-container class="text-black text-left home-content mt-5" v-else>
    <b-row class="my-5" v-if="!profile.loggedIn">
      ...
      <b-col v-else>
        ...
        <div class="mt-5 text-left"><b-button class="btn-action" variant="outline-warning" @click.prevent="startLogin()">Login to Begin</b-button> <span router-tag="span" v-b-tooltip.hover="{ variant: 'light' }" :title="'You\'ll need a Stacks Wallet to own your NFTs - NFTs are a new form of digital property that you own!'" class="text-black ml-3" variant="outline-success"> <b-icon class="ml-0" icon="question-circle"/></span></div>
      </b-col>
    </b-row>
